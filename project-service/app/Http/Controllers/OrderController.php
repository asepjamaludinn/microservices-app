  ...
  public function index(Request $request)
{
    ...
    return $this->paginatedResponse(OrderResource::collection($orders), 'Data pesanan berhasil diambil.');
}
    ...
    public function myOrders(Request $request)
{
    ...
    return $this->paginatedResponse(OrderResource::collection($orders), 'Data pesanan Anda berhasil diambil.');
}
